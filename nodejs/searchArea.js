exports.ResultOfSearchArea = function (dataArea) {
    ...
    if (dataArea != "") {
        ...
        dataArea.forEach(function (item) {
            resultSearch += "<div class=\"item-result\">\n" +
                "                <a href=\"http://localhost:8084/diadiem/thongtin?name=" + item.AreaName + "\"><h5>" + item.AreaName + "</h5></a>\n" +
                "                <div class='linkItem'>http://localhost:8084/" + item.AreaName + "-" + item.Address + "</div>\n" +
                "                <div class=\"descript\">\n" +
                item.Descript +
                "                </div>\n" +
                "            </div>";
